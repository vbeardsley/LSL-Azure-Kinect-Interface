...
void sendData(k4a_device_t device, char* serial_number, k4a_device_configuration_t config, k4abt_tracker_t tracker) {
    //Constants.
    float FRAME_RATE;
    ...
    case K4A_FRAMES_PER_SECOND_15 :
        FRAME_RATE = 15;
        std::cout << "Can't process images this fast" << std::endl;
        return;
        break;
    ...
    case K4A_COLOR_RESOLUTION_1080P :
        std::cout << "Can't process images of this size" << std::endl;
        return;
        break;
    ...
    case K4A_IMAGE_FORMAT_COLOR_BGRA32 :
        ...
        colorType = lsl::channel_format_t::cf_int8;
        break;
    ...
    case (K4A_DEPTH_MODE_NFOV_2X2BINNED):
        ...
        DEPTH_WIDTH = 320;
        DEPTH_SIZE = DEPTH_HEIGHT * DEPTH_WIDTH;
        depthType = lsl::channel_format_t::cf_int16;

        IR_HEIGHT = 288;
        IR_WIDTH = 320;
        IR_SIZE = DEPTH_HEIGHT * DEPTH_WIDTH;
        irType = lsl::channel_format_t::cf_int16;
        break;
    ...
    case (K4A_DEPTH_MODE_WFOV_2X2BINNED):
        std::cout << "Can't process these kinds of depth images" << std::endl;
        return;
        break;
    ...
    for (int i = 0; i < 100; i++)
    {
        ...
        if (tracker != NULL) {
            ...
            k4a_wait_result_t pop_frame_result = k4abt_tracker_pop_result(tracker, &body_frame, 50);
            if (pop_frame_result == K4A_WAIT_RESULT_SUCCEEDED)
            {
                size_t num_bodies = k4abt_frame_get_num_bodies(body_frame);
                if (num_bodies > 1) {
                    printf("Error: Too many bodies");
                }
                else 
                {
...
int main() {
    ...
    sendData(device, serial_number, config, tracker);
